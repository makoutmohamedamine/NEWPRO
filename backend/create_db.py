...
def create_database():
    ...
    try:
        ...
        print("\n[ERREUR] Impossible de se connecter à PostgreSQL (Erreur d'authentification probable).")
        print("Veuillez vérifier que le mot de passe de l'utilisateur PostgreSQL est correct.")
        sys.exit(1)
